...
<html lang="vi"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>DS2API</title>
...
</head><body><main><h1>DS2API</h1><p>Giao diện API tương thích DeepSeek sang OpenAI & Claude</p><div class="links"><a href="/admin">Bảng quản trị</a><a href="/v1/models">Trạng thái API</a><a href="https://github.com/namlevia/ds2api" target="_blank">GitHub</a></div></main></body></html>`
